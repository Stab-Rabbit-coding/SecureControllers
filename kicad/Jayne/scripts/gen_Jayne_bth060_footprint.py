...
# -*- coding: utf-8 -*-
"""
gen_jayne_bth060_footprint.py -- clean-room carrier footprint for the PHYTEC
...
Pad names A1..A60/B1..B60/C1..C60/D1..D60 match Jayne_SoM_PCM071.kicad_sym so the
...
def main():
    L = ["(footprint \"phyCORE-AM62x_PCM071_2xBTH-060\" (version 20240108) "
         ...
         'A1..D60 match Jayne_SoM_PCM071. Verify row<->column + pin-1 vs Fig 6.")',
         "  (attr smd)",
