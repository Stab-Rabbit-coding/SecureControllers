...
Usage:  python3 gen_jayne.py   (run from any dir)
"""
        ...
        "board": {
            "design_settings": {
                "defaults": {
                    ...
                    "other_text_size_h": 0.7,
                    "other_text_size_v": 0.7,
...
# themselves remain the deliberate "2-row placeholder" (see gen_jayne_pcb.py
...
def gen_sch() -> str:
    ...
    lib = [
        ...
        # install): same nets, populate one per build. See gen_jayne_ds_footprints.py.
    ...
    parts.append(
        text_note(
            "JAYNE — Nose/Cargo-Bay Vision, ToF & Laser Board  |  STANDALONE PCB, NOT a PB2-I cape",
            10,
            8,
            2.0,
        )
    ...
    sch = [
        ...
        '    (comment 4 "DESIGN EXPLORATION — see gen_jayne.py docstring for verification status")',
        "  )",
    ]
    sch.extend(parts)
    sch.append(")")
