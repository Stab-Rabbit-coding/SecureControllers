 ...
 *
 * Drives the Texas Instruments BQ76930PWRQ1 on the FlightEngineer power distribution
 ...
 * On FlightEngineer, CRC mode IS enabled (DFSEL tied appropriately during board layout).
 *
 ...
 * of Q_BATT_DSG / Q_BATT_CHG MOSFETs on FlightEngineer.  In normal operation, both
 ...
 *   [3] FlightEngineer.md — Serenity UAV Power Distribution Board specification.
 *
 ...
 * the default address.  On FlightEngineer this is 0x08.
 */
